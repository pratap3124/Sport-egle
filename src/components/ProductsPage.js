...
const ProductsPage = () => {
  ...
  const products = [
  { id: 1, name: "Sports Jersey 1", price: "199.99/-", image: "\jersey13.jpg" },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12 font-semibold">
        <h2 className="text-xl font-bold text-center text-gray-800 mb-4">Our Products</h2>
        <select 
          className="w-35 p-2 border rounded-md text-sm mb-6 hover:bg-white-600"
